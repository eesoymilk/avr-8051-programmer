...
FUSE_H  = 0xd9
AVRDUDE = avrdude -C C:/AVR/avrdude/avrdude.conf -v -V -p $(DEVICE) -c stk500v1 -P COM3 -b 19200 -D # edit this line for your programmer

CFLAGS  = -Iusbdrv -I. -I/mnt/c/AVR/avr8-gnu-toolchain/avr/include -DDEBUG_LEVEL=0
